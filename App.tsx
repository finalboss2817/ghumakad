...
const App: React.FC = () => {
  ...
  const handleGenerate = async (prefs: TravelPreferences) => {
    ...
    try {
      ...
      let errorMessage = "Masterplan Sync Failed. Check Supabase Edge Function logs.";
      
      if (error.message?.includes("CORS")) {
        errorMessage = "CORS Error: The Edge Function rejected the request. Ensure CORS headers are correctly configured in your Deno script.";
      } else if (error.message?.includes("404")) {
        errorMessage = "Edge Function Not Found: Ensure the function 'generate-itinerary' is deployed in Supabase.";
      }
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 md:gap-24 items-center">
                    ...
                    <div className="flex flex-col md:flex-row gap-8 group">
                      ...
                      <div>
                        ...
                        <p className="text-slate-500 font-bold text-base md:text-lg leading-relaxed">
                          We cluster attractions geographically using high-performance server-side AI to ensure you spend more time exploring and less time in transit.
                        </p>
                      </div>
                    </div>
                  </div>
                ...
                <div className="relative mt-12 lg:mt-0">
                  <div className="bg-white rounded-[3rem] md:rounded-[5rem] p-10 md:p-16 shadow-[0_80px_160px_-40px_rgba(0,0,0,0.15)] border border-slate-100 relative z-10 overflow-hidden">
                    <h3 className="text-3xl md:text-4xl font-black text-emerald-950 mb-10 uppercase tracking-tighter leading-tight">Ghumakad Ecosystem <br/><span className="text-slate-300">v1.8 Server Intel Active</span></h3>
                      ...
                      <div className="flex items-center justify-between p-4 bg-emerald-50 rounded-2xl">
                        <div className="flex items-center gap-6">
                           ...
                           <div>
                              ...
                              <p className="text-[10px] font-bold text-emerald-600">Secure Server Processing Enabled</p>
                           </div>
                        </div>
        ...
        {view === 'plan' && (
          <div className="max-w-4xl mx-auto px-6 py-20 md:py-32">
            <div className="text-center mb-16 md:mb-24">
               ...
               <p className="text-slate-400 text-xl md:text-2xl font-bold max-w-2xl mx-auto leading-relaxed">Input your destination. Receive a geographically optimized masterplan crafted for real explorers.</p>
            </div>
          ...
          <div className="max-w-6xl mx-auto px-4 md:px-6 py-20 md:py-24">
            {loading ? (
              <div className="flex flex-col items-center justify-center min-h-[600px]">
                ...
                <p className="text-slate-400 font-black uppercase tracking-[0.3em] mt-6 text-xs text-center italic">Processing via Secure Edge Server</p>
              </div>
            ) : currentItinerary ? (
              <ItineraryView 
